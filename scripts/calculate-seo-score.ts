...
function calculateSEOScore(): SEOScore {
  ...
  htmlFiles.forEach((file) => {
    ...
    if (/<meta[^>]*property=["']og:title["']/.test(content) &&
  ...
  structuredDataDetails.push(`${pagesWithStructuredData}/${htmlFiles.length} pages have structured data`);
  ...
  mobileDetails.push(`${htmlFiles.length - pagesWithoutViewport}/${htmlFiles.length} pages have viewport meta tag`);
