...
### Page Coverage
- Pages with title tags: ${metrics.pagesWithTitle}/${metrics.totalPages} (${Math.round(metrics.pagesWithTitle / metrics.totalPages * 100)}%)
- Pages with meta descriptions: ${metrics.pagesWithDescription}/${metrics.totalPages} (${Math.round(metrics.pagesWithDescription / metrics.totalPages * 100)}%)
- Pages with Open Graph tags: ${metrics.pagesWithOGTags}/${metrics.totalPages} (${Math.round(metrics.pagesWithOGTags / metrics.totalPages * 100)}%)
- Pages with structured data: ${metrics.pagesWithStructuredData}/${metrics.totalPages} (${Math.round(metrics.pagesWithStructuredData / metrics.totalPages * 100)}%)
- Pages with hreflang tags: ${metrics.pagesWithHreflang}/${metrics.totalPages} (${Math.round(metrics.pagesWithHreflang / metrics.totalPages * 100)}%)
- Pages with canonical URLs: ${metrics.pagesWithCanonical}/${metrics.totalPages} (${Math.round(metrics.pagesWithCanonical / metrics.totalPages * 100)}%)

### Images
- Total images: ${metrics.totalImages}
- Images with alt text: ${metrics.imagesWithAlt}/${metrics.totalImages} (${Math.round(metrics.imagesWithAlt / metrics.totalImages * 100)}%)
