    ...
    this.innerHTML = `
      <div class="glossary-container" role="region" aria-labelledby="glossary-heading">
        ...
        ${Object.entries(byCategory)
          ...
          <section aria-labelledby="glossary-${category
            .toLowerCase()
            .replace(/\s+/g, '-')}-heading">
            <h3 id="glossary-${category
              .toLowerCase()
              .replace(/\s+/g, '-')}-heading">${category}</h3>
              ...
              ${categoryTerms
                .map(term => {
                  ...
                  <dd>
                    <p>${definition}</p>
                    ${
                      term.simplified && readingLevel === 'standard'
