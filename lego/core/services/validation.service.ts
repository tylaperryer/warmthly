...
} from '@api/middleware/input-validation.js';
...
export interface IValidationService extends IService {
  ...
  validateUrl(value: unknown, options?: { readonly required?: boolean; readonly allowedProtocols?: readonly string[] }): ValidationResult;
  validateCurrency(value: unknown, allowedCurrencies?: readonly string[]): ValidationResult;
  validateRequestBody(body: unknown, schema: Record<string, (value: unknown) => ValidationResult>): { readonly valid: boolean; readonly errors?: Record<string, string>; readonly sanitized?: Record<string, unknown> };
