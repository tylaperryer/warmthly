...
```html
<warmthly-textarea name="message" label="Message" required placeholder="Enter your message...">
</warmthly-textarea>
```
...
<warmthly-modal id="myModal" title="Confirm Action">
  ...
  <warmthly-button slot="footer" variant="primary" onclick="confirmAction()"
    >Confirm</warmthly-button
  >
</warmthly-modal>
```
