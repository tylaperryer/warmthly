 ...
 * ```
 */
export function getCSSVariable<K extends keyof CSSVariables>(variable: K): string {
 ...
 * ```
 */
export function setCSSVariable<K extends keyof CSSVariables>(variable: K, value: string): void {
  if (typeof document === 'undefined') {
    return;
  }
