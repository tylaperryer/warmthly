 ...
 */
export function saveTextSpacingPreferences(preferences: Partial<TextSpacingPreferences>): void {
  if (typeof window === 'undefined' || typeof localStorage === 'undefined') {
    return;
  }
 ...
 */
export function applyTextSpacing(preferences?: TextSpacingPreferences): void {
  ...
  if (prefs.enabled) {
    ...
    root.style.setProperty('--text-spacing-letter', `${prefs.letterSpacing * 0.12}em`);
    root.style.setProperty('--text-spacing-word', `${prefs.wordSpacing * 0.16}em`);
    root.style.setProperty('--text-spacing-line', `${prefs.lineHeight * 1.618}`);
    root.style.setProperty('--text-spacing-paragraph', `${prefs.paragraphSpacing * 2}rem`);
