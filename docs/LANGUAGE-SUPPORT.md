...
Warmthly now supports **7,019 languages** using **100% open-source, privacy-first translation providers**. This includes:
...
```javascript
// Via URL parameter
https://www.warmthly.org/?lang=ar

// Via JavaScript
import { updateRTLSupport } from '/lego/utils/rtl-support.js';
