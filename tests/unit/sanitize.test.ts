...
describe('Sanitize', () => {
  ...
  describe('escapeHtmlAttribute', () => {
    it('should escape attribute values', () => {
      ...
      expect(escapeHtmlAttribute("value'with'apostrophes")).toBe('value&#x27;with&#x27;apostrophes');
  ...
  describe('createElementWithAttributes', () => {
    it('should create element with attributes', () => {
      const element = createElementWithAttributes('a', { href: 'https://example.com', class: 'link' }, 'Click me');
